...
Route::get('/captcha/math', [CaptchaController::class, 'mathCaptcha'])->name('captcha.math');
Route::post('/captcha/verify-math', [CaptchaController::class, 'verifyMath'])
    ->name('captcha.verifyMath');
Route::post('/connect/store', [ConnectController::class, 'store'])->middleware('throttle:5,1')->name('connect.store');
